        ...
        <div className="flex flex-col gap-5">
          ...
          >
            <div className="space-y-4 font-mono-ui text-[13px] leading-[1.9] text-t2">
              ...
              <p>
                ...
                and <span className="text-v3">CI/CD pipelines</span> — actively
                looking for full-stack and backend roles where I can ship real
                things to real users.
              </p>
            </div>
          </motion.div>
          <CodeWindow fileName="fuzail.config.ts">
            ...
            <div className="xl:hidden">
              ...
              {["Next.js", "TypeScript", "PostgreSQL", "Drizzle", "Docker"].map(
                (s) => (
